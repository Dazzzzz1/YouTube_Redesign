    ...
    return ( <>
        <nav className="menuMedia_box">
            <button className="menuMedia_btn">
                <svg class="side_nav_btn_img" id="side_nav_btn_img_home" width="20" height="19" viewBox="0 0 20 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="side_nav_btn_text" id="home">Home</div>   
            </button>
            <button className="menuMedia_btn">
                <svg class="side_nav_btn_img" xmlns="http://www.w3.org/2000/svg" width="16" height="21" fill="none">
                ...
                <div class="side_nav_btn_text">Trending</div>
            </button>
            <button className="menuMedia_btn">
                <svg class="side_nav_btn_img" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                ...
                <div class="side_nav_btn_text">Subscriptions</div>
            </button>
            <button className="menuMedia_btn">
                <svg class="side_nav_btn_img" xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="none">
                ...
                <div class="side_nav_btn_text">Library</div>       
            </button>
        </nav>
    </> );
}
